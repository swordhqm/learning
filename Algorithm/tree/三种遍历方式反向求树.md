...
```
一个前序遍历序列和一个中序遍历序列可以确定一颗唯一的二叉树, 看起来不完全正确，但是在没有重复字母的情况下应该是正确的。
https://www.zhihu.com/question/35636543
...
http://blog.csdn.net/fengxinlinux/article/details/52950312
```
